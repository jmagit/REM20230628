...
public class Calculadora {
    ...
    public double calc(String operando2, char nuevoOperador) throws CalculadoraException {
    	return calcula(operando2, nuevoOperador);
    }
    ...
    public static record Operacion(double operando, char operador) {
        public Operacion(String operando, char operador) {
            this(Double.parseDouble(operando.replace(',', '.')), operador);
        }
    	public static Operacion toOperacion(String operando, char operador) {
    		return new Operacion(Double.parseDouble(operando.replace(',', '.')), operador);
    	}
    }
    ...
    public double calcula(List<Operacion> operaciones) throws CalculadoraException {
        ...
        for (Operacion operacion : operaciones) {
            calcula(operacion.operando(), operacion.operador());
        }
        return getAcumulado();
    }
