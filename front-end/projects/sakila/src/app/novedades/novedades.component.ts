...
import { ErrorMessagePipe, PastOrPresentValidator } from 'jma-core';
...
export class NovedadesDAOService {
  ...
  query(fecha: string): Observable<Array<any>> {
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, PeliculasListBodyComponent, FormsModule, PastOrPresentValidator, ErrorMessagePipe, ],
